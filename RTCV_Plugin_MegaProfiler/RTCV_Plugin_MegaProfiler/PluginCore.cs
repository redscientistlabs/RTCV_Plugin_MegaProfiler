...
namespace PLUGIN_MEGAPROFILER
{
    [Export(typeof(IPlugin))]
    public class PLUGIN_MEGAPROFILER : IPlugin, IDisposable
    {
        //-------[ Plugin metadata ]-------
        ...
        public string Name => nameof(PLUGIN_MEGAPROFILER).Replace("_"," ");
        ...
        public bool Stop()
        {
            if (PLUGIN_MEGAPROFILER.CurrentSide == RTCSide.Client && !S.ISNULL<PluginForm>() && !S.GET<PluginForm>().IsDisposed)
            {
