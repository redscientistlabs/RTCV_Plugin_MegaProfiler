...
namespace PLUGIN_MEGAPROFILER
{
    ...
    {
        PLUGIN_MEGAPROFILER plugin;
        public PluginConnectorRTC(PLUGIN_MEGAPROFILER _plugin)
        {
            plugin = _plugin;
                ...
                case Commands.SHOW_WINDOW:
                    try
                    {
                        SyncObjectSingleton.FormExecute(() =>
                        {
                            ...
                            {
                                PLUGIN_MEGAPROFILER.PluginForm = new PluginForm(plugin);
                                S.SET<PluginForm>(PLUGIN_MEGAPROFILER.PluginForm);
                            }
